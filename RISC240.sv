...
`endif
  ...
  // multiplication coprocessor wires
  logic [15:0] mulOut, out; //out chosen btw mulOut or aluOut
  logic mul_done;
  logic mul_start;
  logic mul_result_sel;
  logic mul_CC_sel;
  ...
  assign {r7, r6, r5, r4, r3, r2, r1, r0} = regView;
   ...
   controlpath cp(.out(cPts),
                  ...
                  .mul_done(mul_done),
                  .mul_start(mul_start),
                  .mul_result_sel(mul_result_sel),
                  .mul_CC_sel(mul_CC_sel));
   ...
   datapath dp(.ir(ir),
               ...
               .viewReg(regView),
               .aluResult(aluOut),
               .mulResult(mulOut),    // multiplication coprocessor output
               .Result(out),          // final result output
               .pc(pc),
               .memAddr(memAddr),
               .MDRout(memData),
               .dataBus(dataBus),
