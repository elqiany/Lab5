...
design_libs=(dist_mem_gen_v8_0_15 xil_defaultlib)
...
compile()
{
  vlogan -work dist_mem_gen_v8_0_15 $vlogan_opts +v2k \
...
reset_run()
{
  files_to_remove=(ucli.key dist_mem_gen_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dist_mem_gen_0_simv.daidir vcs_lib c.obj)
