...
#
# Script generated by Vivado on Wed Apr 15 19:31:38 EDT 2026
...
#
# Usage        : dist_mem_gen_0.sh
#                dist_mem_gen_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dist_mem_gen_0.sh [-reset_run]
#                dist_mem_gen_0.sh [-reset_log]
#                dist_mem_gen_0.sh [-help]
#
...
#                script (type 'dist_mem_gen_0.sh -help' for more information).
#
...
design_libs_elab="-libname dist_mem_gen_v8_0_15 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver dist_mem_gen_v8_0_15 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "dist_mem_gen_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dist_mem_gen_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work dist_mem_gen_v8_0_15 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dist_mem_gen_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dist_mem_gen_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dist_mem_gen_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: dist_mem_gen_0.sh [-step]\n\
Usage: dist_mem_gen_0.sh [-lib_map_path]\n\
Usage: dist_mem_gen_0.sh [-reset_run]\n\
Usage: dist_mem_gen_0.sh [-reset_log]\n\
Usage: dist_mem_gen_0.sh [-keep_index]\n\
