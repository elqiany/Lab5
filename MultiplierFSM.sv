...
module Task2FSM(
    ...
    always_comb begin
        ...
        //if LSB = 1, go to add where A added to product
            INIT: begin
                if (lsbB1) begin
                    nextState = ADD;
                    prod_en = 1'b1;
                ...
                //else go to shift, multiplication starts
                else begin
                    nextState = SHIFT;
                    prod_en = 1'b0;
                    prod_sel = 1'b1;
            ...
            //shift to now start multiplication alg.
            SHIFT: begin
                if (exit_loop) begin
                    nextState = CHECK;
                    prod_en = 1'b0;
                ...
                //restart loop (loop hasn't reached 8)
                else begin
                    nextState = INIT;
                    prod_en = 1'b0;
                    prod_sel = 1'b1;
            ...
            //checks Z and N to output done and ZN flags
            CHECK: begin
