...
module controlpath (
   ...
   output logic      mul_CC_sel);   //choose alu or mult CCs
...
`endif
        ...
        MUL2: begin
            out = {F_A, MUX_REG, MUX_REG, DEST_REG, LOAD_CC, NO_RD, NO_WR};
            mul_result_sel = 1'b1;
            mul_CC_sel = 1'b1;
            nextState = FETCH;
        end
        ...
        MULI4: begin
            out = {F_A, MUX_REG, MUX_MDR, DEST_REG, LOAD_CC, NO_RD, NO_WR};
            mul_result_sel = 1'b1;
            mul_CC_sel = 1'b1;
            nextState = FETCH;
        end
