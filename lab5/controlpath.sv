...
`endif
        ...
        //FSM for multiplication
        MUL: begin
           // make microinstruction here
           out = {7'b0110_000, MUX_REG, MUX_REG, DEST_REG, LOAD_CC, NO_RD, NO_WR};
           nextState = FETCH;
        end


        // Reference any other instruction above with an immediate 
        MULI: begin
           // make microinstruction here
           out = {7'b0110_000, MUX_REG, MUX_REG, DEST_REG, LOAD_CC, NO_RD, NO_WR};
           nextState = MULI1;
